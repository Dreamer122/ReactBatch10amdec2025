...
<div className="w-full max-w-sm bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
    <a href="#">
        <img className="rounded-base mb-6" src={prd.images?.[0]} alt="product image" />
    </a>
    <div>
        ...
        <a href="#">
            <h5 className="text-xl text-heading font-semibold tracking-tight">{prd.title}</h5>
        </a>
        <div className="flex items-center justify-between mt-6">
            <span className="text-3xl font-extrabold text-heading">${prd.price}</span>
